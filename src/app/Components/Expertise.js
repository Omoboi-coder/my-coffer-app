    ...
    <section id='expertise' className='bg-coffer-dark relative overflow-hidden'>
        ...
        relative z-10'>
            ...
            mt-10 md:mt-[-4.8rem] text-white'>
                ...
                />
                <div className='px-5 md:px-10 space-y-10 md:space-y-20'>
            ...
            {/* outer div */}
                ...
                <h3 className='w-[209] h-[32px] text-[20px] md:text-[45px] md:w-[470px] md:h-[52px]'>Automated Efficiency</h3>
                <h3 className='w-[219] h-[32px] text-[20px] md:text-[45px] md:w-[492px] md:h-[52px]' >Compliance Assurance</h3>
