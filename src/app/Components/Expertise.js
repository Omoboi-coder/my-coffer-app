  ...
  return (
    <section id='expertise' className='bg-coffer-dark overflow-hidden'>
        ...
        {/* Background overlay remains the same */}
         <div className="absolute z-0 opacity-100 md:right-50 right-0 left-[-12rem]
      ...
      /> 
            ...
            <div ref={headerRef} className={`flex flex-col w-[382px] h-[410px] md:w-[631px] md:h-[504px] gap-7 md:gap-10 
            ...
            ${headerVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
                ...
                <h3 className={`text-[20px] md:text-[30px] transition-all duration-600 delay-200 ease-out
                ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  Our Expertise
                </h3>
                
                <h2 className={`text-[40px] leading-12 md:leading-16 mt-5 md:text-[58px] w-[362px] h-[144px]
                 md:w-[631px] md:h-[160px] transition-all duration-800 delay-400 ease-out
