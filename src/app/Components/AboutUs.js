    ...
    <section id='aboutus' className='relative bg-coffer-dark overflow-hidden'>
        {/* Custom background image overlay */} 
         {/* <div 
          className="absolute left-0 md:left-[30rem] 2xl:left-[51rem] w-72 h-48
           md:w-[900px] 2xl:w-[1400px] md:h-[900px] z-0 opacity-30 bg-contain bg-no-repeat bg-center "
          style={{
      ...
      />
        ...
        text-white relative overflow-hidden z-10'>
            {/* div 1 */}
         <div className='flex flex-col mx-auto md:mx-15 w-[385px] h-[552px] md:w-[480px] md:h-[496px] mt-12 md:mt-[4rem] gap-8 md:gap-9'>
            ...
            width={350}
            height={220}
            className="hidden md:flex w-[350px] h-[220px] rounded-[8px] mt-[5rem]"
            />
