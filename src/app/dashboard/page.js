...
const dashboard = () => {
  return (
    <DashboardLayout>
        ...
        {/* search div */}
        <div className='flex flex-row md:absolute right-5 top-20 w-[366px] md:w-[285px] h-[40px] 
          md:h-[50px] rounded-[12px] text-[12px] text-[#B6B6B6] md:p-4 p-2.5   ml-9 md:ml-0 gap-2
